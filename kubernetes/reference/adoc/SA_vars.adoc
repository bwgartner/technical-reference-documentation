...
:rev2-date: 2024-10-07


// General
// - metadata variables just begin with "m"
:trd: Technical Reference Documentation

:mSeries: Technical References
:mType: Reference
...
:mType: Reference Configuration
endif::RC[]

// Reference Implementation
ifdef::RI[]
:title: Introductory Deployment
:mType: Reference Implementation
